...
> 
  ...
  > data$age_midpoint <- case_when(
    +     data$age_group == "15-20" ~ 17.5,
    +     data$age_group == "20-25" ~ 22.5,
    +     data$age_group == "25-30" ~ 27.5,
    +     data$age_group == "30-35" ~ 32.5,
    +     data$age_group == "35-40" ~ 37.5,
    +     data$age_group == "40-45" ~ 42.5,
    +     data$age_group == "45-50" ~ 47.5,
    +     data$age_group == "50-55" ~ 52.5,
    +     data$age_group == "55-60" ~ 57.5,
    +     data$age_group == "60-65" ~ 62.5,
    +     data$age_group == "65-70" ~ 67.5,
    +     data$age_group == "70-75" ~ 72.5,
    +     data$age_group == "75-80" ~ 77.5,
  ...
  > ggplot(data, aes(x = age_midpoint, y = charges)) +
    +     geom_point() +
  ...
  > ggplot(data, aes(x = charges)) +
    ...
    +     stat_function(fun = dnorm, 
                        +                   args = list(mean = mean(data$charges, na.rm = TRUE), 
                                                        +                               sd = sd(data$charges, na.rm = TRUE)), 
